...
- `@deepseek-ai/dsh-client-locale-ru`（[`packages/extensions/locale-ru/src/index.ts`](../packages/extensions/locale-ru/src/index.ts)）
...
- `@deepseek-ai/dsh-experimental-browser-use-profile`（[`packages/experimental/browser-use-profile/src/index.ts`](../packages/experimental/browser-use-profile/src/index.ts)）
